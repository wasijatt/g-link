...
const Workscards = () => {
    ...
    <p className="text-[16px] font-light my-8 ">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s</p>
